...
Directories generated by `create_shared_context` and `enable_workstream_context`, inventory backups, and copied authorized sources belong to the context. Package uninstall or reinstall must not remove them.
